...
(function() {
	...
	function attachEventListeners() {
		...
		function handlestart(event){			
			...
			if(event.changedTouches){
				...
				Array.prototype.forEach.call(touches, function(touch){
					toggleTracker.addMovement(touch.pageX);
				});
			} else {
		...
		toggle.addEventListener('mousedown', handlestart, false);
		toggle.addEventListener('mousemove', handlemove, false); 
		toggle.addEventListener('mouseup', handleend, false);
	}
